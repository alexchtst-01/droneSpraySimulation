...
first_sim_values = []
first_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case1", planeSize=12, planeHeight=30, savingMode=True)
print("Case 1")
first_sim.runSimulation(num_plane=8, vel=1, state=lambda i : i % 20 > 0)
first_sim.Animation(name="planeHeight_30-num_plane_8.gif")
...
for i in range(9): #Iterate for 9 times, because we already have 1 data
    first_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case1", planeSize=12, planeHeight=30)
    first_sim.runSimulation(num_plane=8, vel=1, state=lambda i : i % 20 > 0)
...
second_sim_values = []
second_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case2", planeSize=12, planeHeight=30, savingMode=True)
print("\nCase 2")
second_sim.runSimulation(num_plane=8, vel=1, state=lambda i : i % 20 > 0)
second_sim.Animation(name="planeHeight_15-num_plane_8.gif")
...
for i in range(9): #Iterate for 9 times, because we already have 1 data
    second_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case2", planeSize=12, planeHeight=15)
    second_sim.runSimulation(num_plane=8, vel=1, state=lambda i : i % 20 > 0)
...
third_sim_values = []
third_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case3", planeSize=12, planeHeight=15, savingMode=True)
print("\nCase 3")
third_sim.runSimulation(num_plane=4, vel=1, state=lambda i : i % 20 > 0)
third_sim.Animation(name="planeHeight_15-num_plane_4.gif")
...
for i in range(9): #Iterate for 9 times, because we already have 1 data
    third_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case3", planeSize=12, planeHeight=15)
    third_sim.runSimulation(num_plane=4, vel=1, state=lambda i : i % 20 > 0)
...
fourth_sim_values = []
fourth_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case4", planeSize=12, planeHeight=30, savingMode=True)
print("\nCase 4")
fourth_sim.runSimulation(num_plane=4, vel=1, state=lambda i : i % 20 > 0)
fourth_sim.Animation(name="planeHeight_30-num_plane_4.gif")
...
for i in range(9): #Iterate for 9 times, because we already have 1 data
    fourth_sim = sprayAircraft(farm_size=200, simulation_result_dir="Case4", planeSize=12, planeHeight=30)
    fourth_sim.runSimulation(num_plane=4, vel=1, state=lambda i : i % 20 > 0)
